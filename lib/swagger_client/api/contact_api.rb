...
module SwaggerClient
  class ContactApi
    ...
    def contact_track_post(api_key, team_id, email, tag, opts = {})
      data, _status_code, _headers = contact_track_post_with_http_info(api_key, team_id, email, tag, opts)
      return data
    end
    ...
    def contact_track_post_with_http_info(api_key, team_id, email, tag, opts = {})
      if @api_client.config.debugging
      ...
      fail ArgumentError, "Missing the required parameter 'tag' when calling ContactApi.contact_track_post" if tag.nil?
      # resource path
