...
module SwaggerClient
  ...
  class Contact
    attr_accessor :encrypted_team_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'encryptedTeamId')
        self.encrypted_team_id = attributes[:'encryptedTeamId']
      end

      if attributes.has_key?(:'encryptedId')
        self.encrypted_id = attributes[:'encryptedId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          encrypted_team_id == o.encrypted_team_id &&
          encrypted_id == o.encrypted_id &&
    ...
    def hash
      [encrypted_team_id, encrypted_id, first_name, last_name, email, company, birthday, tags, custom_fields].hash
    end
