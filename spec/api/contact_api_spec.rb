...
describe 'ContactApi' do
  ...
  describe 'test an instance of ContactApi' do
    it 'should create an instact of ContactApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ContactApi)
    end
  end

  # unit tests for contact_identify_post
  ...
  describe 'contact_identify_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for contact_track_post
  ...
  describe 'contact_track_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
